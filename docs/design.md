...
基于 React + Vite 的本地照片展览 Web 应用。用户选择本地文件夹（照片不上传），以主题化的方式阅读照片。当前共 **31 个主题**、**8 种阅读范式**（见下），全部共享同一套设计 Token 架构与比例感知布局引擎。

> 其中 15 个"文艺作品题材"主题（星际穿越/布达佩斯/纪念碑谷/银翼杀手/山海经/EVA/黑泽明/小王子/爱死机/风之旅人/奥威尔/克苏鲁/蒸汽波/冰与火/阿基拉）走画廊流，签名体验由各自背景氛围动画 + hover 特效承载（虫洞扭曲/翻画册/几何旋转/瞳孔光晕/墨晕/AT力场/刀光/星点/翻转/白光/扫描线/理智扭曲/VHS色差/龙焰/能量爆发）；另有 4 个题材（吉卜力/侘寂/沙丘/黑镜）在 plan.md 待排期。
